...
export function DemosSection({ language }: DemosSectionProps) {
  ...
  const demos = [
    ...
    },
    {
      ...
      image: 'https://cloudinary.hbs.edu/hbsit/image/upload/s--rYmzoOvr--/f_auto,c_fill,h_375,w_750,/v20200101/6924D8414269166EA10A67361534E92D.jpg',
      url: '/demo/Cross-Agency-Data-Integration/',
      isExternal: false
    }
  ];
  ...
  const handleDemoClick = (index: number) => {
    ...
    if (demo.isExternal) {
      ...
      // For internal demos, show authentication modal
      setSelectedDemo(index);
      setIsAuthModalOpen(true);
    }
  };
  ...
  const handleAuthSuccess = () => {
    if (selectedDemo !== null) {
      ...
      if (demo.isExternal) {
        ...
        // For internal demos, would redirect to demo page
        console.log(`Accessing demo: ${demo.url}`);
      }
